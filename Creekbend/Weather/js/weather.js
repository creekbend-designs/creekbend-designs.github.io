...
// GET THE CONDITIONS
weatherConditions.open('GET', '//api.openweathermap.org/data/2.5/weather?zip=80033,us&units=imperial&appid=39f52db394a9548fab312dd08c5734ed', true);
...
weatherConditions.onload = function() {
    if (weatherConditions.status === 200){
        ...
        var icon_path = "//openweathermap.org/img/w/" + cObj.weather[0].icon + ".png";
...
// GET THE FORECARST
weatherForecast.open('GET', '//api.openweathermap.org/data/2.5/forecast?zip=80033,us&units=imperial&appid=39f52db394a9548fab312dd08c5734ed', true);
...
if (weatherForecast.status === 200){
    ...
    var icon_path = "//openweathermap.org/img/w/" + fObj.list[0].weather[0].icon + ".png";
    ...
    var icon_path = "//openweathermap.org/img/w/" + fObj.list[8].weather[0].icon + ".png";
    ...
    var icon_path = "//openweathermap.org/img/w/" + fObj.list[16].weather[0].icon + ".png";
    ...
    var icon_path = "//openweathermap.org/img/w/" + fObj.list[24].weather[0].icon + ".png";
    ...
    var icon_path = "//openweathermap.org/img/w/" + fObj.list[32].weather[0].icon + ".png";
